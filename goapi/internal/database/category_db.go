...
func (categoryDB *CategoryDB) GetCategoryByID(id string) (*entity.Category, error) {
	var category entity.Category
...
func (categoryDB *CategoryDB) CreateCategory(category *entity.Category) (*entity.Category, error) {
